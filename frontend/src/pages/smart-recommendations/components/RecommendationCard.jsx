...
  groupVotes = [], 
  currentUserId = 1,
  onViewDetails // Prop for opening the detail popup
}) => {
...
  // HANDLER: Card click ko manage karne ke liye
  const handleCardClick = (e) => {
    // Rokna (Prevent) hai agar click kisi action button par ho
...
 return (
    // Main card container is clickable
    <div 
      className="bg-card rounded-xl border border-border shadow-soft hover:shadow-collaborative transition-organic overflow-hidden cursor-pointer"
...
            <button
              onClick={(e) => {
                e.stopPropagation(); // Click event ko card tak jaane se roko
