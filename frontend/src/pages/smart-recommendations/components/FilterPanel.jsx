...
  const [localFilters, setLocalFilters] = useState(filters);
    ...
    // ❌ REMOVED: budgetOptions को हटा दिया गया है क्योंकि हम अब सीधे इनपुट का उपयोग कर रहे हैं।
    // const budgetOptions = [...]
...
      search: '',
      categories: [],
      // ✅ UPDATED: बजट को 'budgetMax' से बदलें
      budgetMax: '', 
      groupSize: '',
      duration: '',
      accessibility: false,
...
      weatherOptimal: false,
      distance: 50, // Distance को भी रीसेट करें
    };
...
    // Non-empty check for strings and numbers (0 is allowed if it's the distance slider default)
...
          {/* ⭐️ MODIFIED: Max Budget Input Field ⭐️ */}
          <div>
            <Input
              label="Max Budget (in ₹)"
              type="number"
              placeholder="e.g., 5000"
              // 'budgetMax' key का उपयोग करें
              value={localFilters?.budgetMax || ''}
              onChange={(e) => handleFilterChange('budgetMax', e?.target?.value === '' ? '' : parseInt(e?.target?.value))}
              className="w-full"
            />
          </div>
          {/* Note: Original Budget Range Select component is replaced by the above Input */}
