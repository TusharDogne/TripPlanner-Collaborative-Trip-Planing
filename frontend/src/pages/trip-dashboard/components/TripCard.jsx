...
          {/* 🚨 Delete Button - Moved to be alongside Chat and Vote */}
          <div className="flex flex-col items-center">
            <Button
              variant="destructive"
              size="sm"
              iconName="Trash"
              onClick={() => {
                // Now checks for the onDelete prop, which is destructured
...
              className="p-3"
            />
            <span className="text-xs mt-1 text-muted-foreground">Delete</span>
          </div>
        </div>
      </div>
