...
// ⭐️ CORRECTED IMPORT: Using TripDetailPopup as per your component name ⭐️
import TripDetailPopup from './components/TripDetailPopup'; 
...
  // ⭐️ STATE ADDED: For managing the Detail Popup ⭐️
...
  // ⭐️ HANDLER: Opens the popup ⭐️
  const handleViewDetails = (recommendation) => {
    setSelectedRecommendation(recommendation);
    setShowDetailPopup(true);
    console.log("Opening details for recommendation:", recommendation?.id);
  };

  // ⭐️ HANDLER: Closes the popup ⭐️
...
      {/* ⭐️ RENDER: Trip Detail Popup ⭐️ */}
      {showDetailPopup && selectedRecommendation && (
        <TripDetailPopup
